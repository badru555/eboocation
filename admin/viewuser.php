...
if ($level!='admin'){
 ...
 <head>
  ...
  <body>
    ...
    $id = $_GET['id'];
    $query = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM user WHERE id='$id'"));
    ?>
    <!-- konten -->
    <div class="container">
      <h2><?php echo $query['username']."'s Account" ?></h2>
      <div class="well">
        <div class="container">
          <div class="row">
            <div class="col-md-2">
    ...
    <div class="container">
     <div class="well">
       <div class="row" style="margin: 10px;">
         <div class="col-md-6">
           <legend><?php echo $query['username'] ?>'s ebook uploads:</legend>
         </div>
       ...
       <table class="table table-striped table-hover table-bordered">
         ...
         <tbody>
           <?php
           $book = mysqli_query($koneksi, "SELECT * FROM ebooks WHERE iduser='$id'");
           $no=1;
           while ($databook=mysqli_fetch_array($book)) {
             ...
             <tr class="row-content">
               ...
               <td>
                 <a class="btn btn-danger btn-xs" href="../action.php?act=deleteebook&id=<?php echo $databook['id'] ?>" aria-label="Settings">
