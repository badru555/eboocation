...
if ($level!='admin'){
 ...
 <head>
  ...
  <body>
    ...
    <!-- konten -->
    <div class="container">
      <h2 style="color: #448aff;text-align: center;">E-books Trash</h2>
      <hr>
      <div class="btn-group" style="margin-bottom: 15px;">
        <a href="../action.php?act=emptytrash" class="btn btn-danger btn-sm" role="button"> <span class="glyphicon glyphicon-trash"></span> Empty trash</a>
      </div>
      <table class="table table-striped table-hover table-bordered">
        ...
        <tbody>
          ...
          $query = mysqli_query($koneksi, "SELECT * FROM ebooktrash");
          $no=1;
          while ($data=mysqli_fetch_array($query)) {
            ...
            <tr class="row-content">
              ...
              <td>
                <a class="btn btn-danger btn-xs" href="../action.php?act=deletepermanent&id=<?php echo $data['id'] ?>&file=<?php echo $data['filename'] ?>" onclick="return confirm('Are you sure to delete it permanently?')">
                  <i class="glyphicon glyphicon-trash" aria-hidden="true"></i>
                </a>
                <a class="btn btn-info btn-xs" href="../action.php?act=restore&id=<?php echo $data['id'] ?>" aria-label="Settings">
                  <i class="glyphicon glyphicon-retweet" aria-hidden="true"></i>
                </a>
                <a class="btn btn-warning btn-xs" href="viewpdf.php?id=<?php echo $data['id'] ?>&a=s" aria-label="Settings">
