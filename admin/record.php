...
if ($level!='admin'){
 ...
 <head>
  ...
  <body>
    ...
    <!-- konten -->
    <div class="container">
      <h2 style="color: #448aff;text-align: center;">All E-books Records</h2>
      <hr>
      <div class="btn-group" style="margin-bottom: 15px;">
        <div class="col-md-6">
          <a href="ebooktrash.php" class="btn btn-warning btn-sm" role="button"> <span class="glyphicon glyphicon-folder-close"></span> Go to trash</a>
          <a href="../user/upload.php" class="btn btn-primary btn-sm" role="button"> <span class="glyphicon glyphicon-upload"></span> Upload New</a>
        </div>
        <div class="col-md-6 pull-right">
          <form class="form-search" action="record.php" method="post">
      ...
      <table class="table table-striped table-hover table-bordered">
        ...
        <tbody>
          ...
          if (isset($_POST['search'])){
            ...
            $query = mysqli_query($koneksi,"SELECT * FROM ebooks WHERE approval='1' AND (title LIKE '%$keyword%' OR author LIKE '%$keyword%' )");
          } else {
            $query = mysqli_query($koneksi, "SELECT * FROM ebooks WHERE approval='1'");
          }
          ...
          while ($data=mysqli_fetch_array($query)) {
            ...
            <tr class="row-content">
              ...
              <td>
                ...
                <a class="btn btn-success btn-xs" href="updateebook.php?id=<?php echo $data['id'] ?>" aria-label="Settings">
